...
if(WIN32 OR UNIX)
  find_path(NsightAftermath_INCLUDE_DIR
    ...
    PATHS
      "$ENV{NSIGHT_AFTERMATH_SDK}/include"
    )
...
if(NOT NsightAftermath_FOUND)
    if(DEFINED ENV{NSIGHT_AFTERMATH_SDK})
        message("NSIGHT_AFTERMATH_SDK environment variable not set to a valid location (is $ENV{NSIGHT_AFTERMATH_SDK})")
    else()
        message("NSIGHT_AFTERMATH_SDK environment variable not set")
    endif()
endif()
